  ...
  <body class="presentation">
    ...
    <main class="presentation__main presentation__main--max-width">
      ...
      <ol>
        ...
        <li><strong>Deaf User</strong> - A user who cannot hear, but can see and uses the mouse and keyboard. We need to remember this user especially when there is audio and video on your site. Written transcripts will be important to this user.</li>
        <li><strong>Learning Disability User</strong> - A user who can see and hear and can use the mouse and keyboard, but they have a learning disability (ie. a person with ADHD or Autism). Content on the site might be overwhelming for this user. They also might not be able to digest the information on the page or understand the subtle user interactions the a feature might require.</li>
      </ol>
    </main>
